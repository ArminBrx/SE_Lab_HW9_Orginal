 ...
 */
public class Memory {
    private List<Adress_Data> codeBlock;
    ...
    public Memory() {
        codeBlock = new ArrayList<Adress_Data>();
    ...
    public int saveMemory() {
        codeBlock.add(new Adress_Data());
        return codeBlock.size() - 1;
    }

    public void add3AddressCode(Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.add(new Adress_Data(op,opr1,opr2,opr3));
    }

    public void add3AddressCode(int i, Operation op, Address opr1, Address opr2, Address opr3) {
        codeBlock.remove(i);
        codeBlock.add(i, new Adress_Data(op, opr1, opr2,opr3));
    }
...
class Adress_Data {
    ...
    public Adress_Data(Operation op, Address opr1, Address opr2, Address opr3) {
        operation = op;
        Operand1 = opr1;
        Operand2 = opr2;
        Operand3 = opr3;
